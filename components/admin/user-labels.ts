...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  AI_QUESTION_MAPPING_BATCH_CREATED: "生成题目映射候选批次",
  AI_QUESTION_MAPPING_BATCH_CONFIRMED: "确认题目映射候选批次",
  COURSE_TEACHING_PROGRESS_UPDATED: "更新课程教学进度",
  COURSE_RECOMMENDATION_POLICY_UPDATED: "更新课程推荐策略",
  PROGRAMMING_CONFIG_REVISION_CREATED: "创建 Python 判题配置修订",
  PROGRAMMING_ATTEMPT_REJUDGED: "重新判定 Python 提交",
  PROGRAMMING_ATTEMPT_REVOKED: "撤销 Python 判题结果",
  RECOMMENDATION_PROGRAMMING_ATTEMPT_REJUDGED: "重判推荐 Python 练习",
  RECOMMENDATION_PROGRAMMING_ATTEMPT_REVOKED: "撤销推荐 Python 判题",
  ASSESSMENT_SCHEME_DRAFT_GENERATED: "生成考核方案草稿",
  ASSESSMENT_SCHEME_REVIEW_SAVED: "保存考核方案审核稿",
  ASSESSMENT_SCHEME_PUBLISHED: "发布考核方案",
  GRADEBOOK_CREATED: "创建成绩台账",
  GRADE_ENTRY_CORRECTED: "修正学生成绩",
  PLATFORM_GRADES_SYNCED: "同步平台作业成绩",
  GRADE_IMPORT_PREVIEWED: "预览成绩导入",
  ...
  COURSE_SURVEY_PUBLISHED: "发布结课问卷",
  COURSE_SURVEY_CLOSED: "关闭结课问卷",
  COURSE_SURVEY_RESPONSE_SUBMITTED: "提交实名问卷",
  COURSE_SURVEY_SUMMARY_GENERATED: "生成问卷汇总",
};
