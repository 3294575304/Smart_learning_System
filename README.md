...
迭代二、三专项验收记录见 [`docs/ITERATION-TWO-THREE-ACCEPTANCE.md`](docs/ITERATION-TWO-THREE-ACCEPTANCE.md)。原有大纲异常消息契约已修复，固定样本合同测试已覆盖 3 项目标、11 章、8 个实验项目、32/20/12 学时和 10%/5%/5%/20%/60% 权重；最新全量质量检查结果见该验收记录。
