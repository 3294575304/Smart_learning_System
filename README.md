...
| V1.0 其余范围                     | 待开发               | Python 基础判题、统一学习事件、画像与掌握度界面、课程图谱联动推荐、自主练习/AI 自述、结课问卷、DOCX 报告和最终整体验收尚未完成           |

迭代四已经完成专项验收，当前开发前沿是迭代五剩余能力：先统一任务/学习事件与判题安全契约，再完成 Python 基础判题、画像快照和证据界面。V1.0 尚未完成整体验收；后续优先级以 [`项目计划书.md`](项目计划书.md) 和 [`AGENTS.md`](AGENTS.md) 为准。
